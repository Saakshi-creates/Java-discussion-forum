...
public class Question extends AbstractEntity
{
	...
	private String title;					//brief description of question
	
	private String message;					//detail question
	
	private User user;						//user who asked the question
	
	private int upvoteCount = 0;			//number of upvotes for the question.
	
	private static Long lastEntry = 0L;		//id of the last question asked on discussion forum
