...
public class Reply extends AbstractEntity
{
	...
	private String message;					//reply body
	
	private User user;						//user who replied to the question
	
	private Question question;				//question for which user has replied
	
	private static Long lastEntry = 0L;		//id of the last reply posted on discussion forum
